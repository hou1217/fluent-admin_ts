...
<script lang="ts">
  ...
  import {ActivityTypeApi} from '@/service'
  import Vue from 'vue';
    ...
    methods: {
      ...
      */
            ...
            },
            {
              ...
              btns: [
                
                {
                    label: '删除',
                    tips: '删除不可恢复，是否删除',
                    handler: (row, index) => {this.onDelete(row, index)}
                }  
              ]
            }
        ];
      ...
      getTableData(searchForm) {
        ...
        return ActivityTypeApi.activityTypeList(searchForm);
      },
      /**
       * 点击删除
       */
      onDelete(row, index) {
          console.log('[activityType.vue]: onDelete');
          // ActivityTypeApi.activityTypeDelete([row.typeId]).then(() => {
          //     this.$message.success('删除成功');
          //     this.$refs.typeTable.$refreshData();
          // });
      },
    }
  })
